...
st.markdown('''
    In theoretical physics, there are a number of mysteriouse questions in gravity and elementary particle. Famous physicists like Einstien, Halking, Oppenheimer\
         and so on also spent their entire life to unify gravity and elementary particle (quantum physics)''')
...
st.markdown('''Holography is a principle that state that weakly interacting classical gravitational gravity in $n+1$ dimensions is equivelent to strongly coupling quantum theory.\
    in $n$ dimensions. Now it is natural to be asked by people "why we need this". The answer is simple, we cannot solve strongly coupling quantum theoryaa''')
